import { HardDrive, Disc, Settings, HardDriveDownload, Download, FileCode, Save, Check } from 'lucide-react';
...
const steps = [
  ...
  { id: 5, label: 'Updates', icon: Download },
  { id: 6, label: 'Unattend', icon: FileCode },
  { id: 7, label: 'Build', icon: Save },
];
