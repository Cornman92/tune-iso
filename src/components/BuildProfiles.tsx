...
const PROFILES: BuildProfile[] = [
  ...
  },
  {
    ...
    name: 'Privacy',
    icon: ShieldCheck,
    description: 'Maximum telemetry removal, cloud sync disabled, tracking endpoints blocked. For users who prioritize data minimization above all else.',
    color: 'text-success',
    summary: [
      'Remove all telemetry & diagnostics components',
      'Disable cloud sync, OneDrive, Copilot, Recall',
      'Block tracking services & scheduled tasks',
      'Apply comprehensive privacy registry tweaks',
      'Keep core functionality & productivity apps',
    ],
    customizations: {
      programs: [],
      tweaks: ['disable-cortana', 'disable-web-search', 'classic-context-menu', 'disable-lock-screen-ads', 'disable-tips', 'disable-consumer-features', 'disable-action-center'],
      optimizations: ['disable-telemetry', 'disable-superfetch'],
    },
    services: [
      'DiagTrack', 'dmwappushservice', 'WerSvc', 'lfsvc', 'RemoteRegistry',
      'MapsBroker', 'WalletService', 'PhoneSvc', 'MessagingService',
      'PcaSvc', 'InventorySvc', 'DevicesFlowUserSvc', 'CDPSvc', 'CDPUserSvc',
      'NaturalAuthentication', 'wisvc', 'WMPNetworkSvc', 'RetailDemo',
      'diagnosticshub.standardcollector.service', 'wercplsupport',
      'WpnService', 'WpnUserService', 'OneSyncSvc', 'PushToInstall',
      'BcastDVRUserService', 'SharedAccess',
    ],
    components: [
      'cortana', 'feedback', 'copilot', 'copilot-runtime', 'recall', 'ai-ocr',
      'onedrive', 'teams', 'your-phone', 'widgets', 'linkedin',
      'bing-weather', 'bing-news', 'bing-finance', 'bing-sports',
      'maps', 'people', 'skype', 'clipchamp', 'gethelp', 'getstarted',
      'lockscreen-spotlight', 'start-recommended',
      'compat-telemetry', 'census', 'diagtrack', 'error-reporting', 'customer-experience',
      'candy-crush', 'candy-crush-friends', 'disney-magic', 'farmville',
      'bubble-witch', 'march-empires', 'hidden-city', 'asphalt-legends',
      'sudoku', 'mahjong', 'jigsaw', 'solitaire',
    ],
    registry: ['p2', 'p4', 'p7', 'p8', 'p10', 'p11', 'p12', 'p13', 'p14'],
    features: [],
  },
  {
    ...
    name: 'LTSC / IoT',
    icon: Cpu,
    description: 'Mimics Windows LTSC: strips Store, consumer apps, Cortana, and enables only enterprise-grade features. Maximum stability and minimal attack surface.',
    color: 'text-muted-foreground',
    summary: [
      'Remove Microsoft Store & all UWP consumer apps',
      'Strip Xbox, games, Copilot, widgets, Cortana',
      'Disable consumer features & telemetry',
      'Enable .NET 3.5 & Hyper-V for compatibility',
      'Keep core system tools & security features',
    ],
    customizations: {
      programs: [],
      tweaks: ['disable-cortana', 'disable-web-search', 'disable-lock-screen-ads', 'disable-tips', 'disable-consumer-features', 'classic-context-menu'],
      optimizations: ['disable-telemetry', 'disable-superfetch', 'disable-prefetch'],
    },
    services: [
      'DiagTrack', 'dmwappushservice', 'WerSvc', 'RetailDemo', 'wisvc',
      'XblAuthManager', 'XblGameSave', 'XboxNetApiSvc', 'XboxGipSvc',
      'BcastDVRUserService', 'WalletService', 'PhoneSvc', 'MessagingService',
      'MapsBroker', 'WMPNetworkSvc', 'PushToInstall', 'PcaSvc', 'InventorySvc',
      'diagnosticshub.standardcollector.service', 'OneSyncSvc', 'TokenBroker',
      'InstallService', 'ClipSVC',
    ],
    components: [
      'cortana', 'bing-weather', 'bing-news', 'bing-finance', 'bing-sports',
      'skype', 'gethelp', 'getstarted', 'feedback', 'maps', 'mixedreality',
      'people', 'teams', 'clipchamp', 'todo', 'powerautomate', 'your-phone',
      'widgets', 'copilot', 'copilot-runtime', 'recall', 'ai-ocr',
      'onenote', 'office-hub', 'office-sway', 'linkedin', 'outlook-new',
      'solitaire', 'candy-crush', 'candy-crush-friends', 'disney-magic',
      'farmville', 'bubble-witch', 'march-empires', 'hidden-city',
      'asphalt-legends', 'sudoku', 'mahjong', 'jigsaw',
      'xbox-app', 'xbox-bar', 'xbox-tcui', 'xbox-identity', 'xbox-speech',
      'xbox-game-callable-ui', 'mixed-reality-viewer', 'whiteboard',
      'groove-music', 'movies-tv', 'paint3d', 'journal', 'family', 'devhome',
      'store', 'store-purchase', 'store-experience',
      'compat-telemetry', 'census', 'diagtrack', 'error-reporting', 'customer-experience',
      'lockscreen-spotlight', 'start-recommended',
    ],
